using Flexlive.CQP.CSharpPlugins.Demo.Common;
using Flexlive.CQP.CSharpPlugins.Demo.Mode;
using Flexlive.CQP.CSharpPlugins.Demo.MongoDb;
...
namespace Flexlive.CQP.CSharpPlugins.Demo
{
    ...
    public class MyPlugin : CQAppAbstract
    {
        ...
        /// 将 Stream 写入文件   
        /// </summary>   
        public void StreamToFile(Stream rs, string fileName)
        {
            ...
            BinaryWriter bw = new BinaryWriter(File.Open("C:\\1111.mp3", FileMode.OpenOrCreate));
            bw.Write(bytes);
            bw.Close();
